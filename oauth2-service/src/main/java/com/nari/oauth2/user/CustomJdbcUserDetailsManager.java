...
public class CustomJdbcUserDetailsManager extends JdbcDaoImpl implements UserDetailsManager,
    ...
    public static final String DEF_CREATE_USER_SQL = "insert into users (username, user_password, enabled) values (?,?,?)";
    public static final String DEF_DELETE_USER_SQL = "delete from users where username = ?";
    public static final String DEF_UPDATE_USER_SQL = "update users set user_password = ?, enabled = ? where username = ?";
    public static final String DEF_INSERT_AUTHORITY_SQL = "insert into authorities (username, authority) values (?,?)";
    public static final String DEF_DELETE_USER_AUTHORITIES_SQL = "delete from authorities where username = ?";
    public static final String DEF_USER_EXISTS_SQL = "select username from users where username = ?";
    public static final String DEF_CHANGE_PASSWORD_SQL = "update users set user_password = ? where username = ?";
    public static final String DEF_USERS_BY_USERNAME_QUERY = "select username,user_password,enabled "
